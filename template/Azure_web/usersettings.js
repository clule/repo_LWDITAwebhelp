...
(function() {
  ...
  model.publish('l.desktop_sidebar_visible', "true");
	model.publish('l.mobile_header_visible', true);
  ...
  var phone_max_width = 0;
  var tablet_max_width = 0;
  var screens = {
  ...
  if(tablet_max_width !== 0) {
    ...
    screens.desktop =  { media_query: 'screen and (min-width: '+ (phone_max_width || tablet_max_width + 1) +'px)' };
  }
